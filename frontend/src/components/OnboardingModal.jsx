...
export default function OnboardingModal({ user, onComplete }) {
    ...
    const handleSubmit = (e) => {
        ...
        // Save locally to avoid backend changes
        localStorage.setItem(`student_onboarding_data_${user?.uid || 'guest'}`, JSON.stringify(onboardingData));
        localStorage.setItem(`onboarding_completed_${user?.uid || 'guest'}`, "true");
